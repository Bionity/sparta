...
from src.data_processing import TokenLevelDecoderProcessor, SpanGenDataset, DataCollatorWithPadding
from src.trainer import TrainingArguments, Trainer
from src.models import DecoderConfig, SpanDecoder

def train(args):
    # Load the model configuration
    backbone_config = AutoConfig.from_pretrained(args.model_path)
    config = DecoderConfig(backbone_model = args.model_path,
    ...
    model = SpanDecoder(config, from_pretrained=True).to(args.device)
